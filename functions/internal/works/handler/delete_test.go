...
func TestDeleteHandler_Handle(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := works.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().DeleteWork(gomock.Any(), "delete-id").Return(nil)
	...
	t.Run("not found", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := works.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().DeleteWork(gomock.Any(), "not-found-id").Return(awsdynamodb.ErrNotFound)
	...
	t.Run("service error", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := works.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().DeleteWork(gomock.Any(), "delete-id").Return(errors.New("service error"))
