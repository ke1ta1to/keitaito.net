...
func TestGetHandler_Handle(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := skills.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().GetSkill(gomock.Any(), "test-id").Return(&skills.Skill{
			ID:      "test-id",
			Name:    "Go",
	...
	t.Run("not found", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := skills.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().GetSkill(gomock.Any(), "not-found-id").Return(nil, awsdynamodb.ErrNotFound)
	...
	t.Run("service error", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := skills.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().GetSkill(gomock.Any(), "test-id").Return(nil, errors.New("service error"))
