...
func TestUpdateHandler_Handle(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := skills.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().UpdateSkill(gomock.Any(), "update-id", "Updated Go", "https://example.com/go-updated.png").Return(&skills.Skill{
			ID:      "update-id",
			Name:    "Updated Go",
		...
		resp, err := h.Handle(context.Background(), events.APIGatewayProxyRequest{
			...
			Body:           `{"name":"Updated Go","icon_url":"https://example.com/go-updated.png"}`,
		})
	...
	t.Run("not found", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := skills.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().UpdateSkill(gomock.Any(), "not-found-id", "Go", "https://example.com/go.png").Return(nil, awsdynamodb.ErrNotFound)
	...
	t.Run("service error", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		mockSvc := skills.NewMockServiceInterface(ctrl)
		mockSvc.EXPECT().UpdateSkill(gomock.Any(), "update-id", "Go", "https://example.com/go.png").Return(nil, errors.New("service error"))
