...
func TestUpdateHandler_Handle(t *testing.T) {
	validBody := `{"name":"Keita","birthday":"1990-01-01","location":"Tokyo","school":"MIT","image_url":"https://example.com/img.png","twitter":"@keita","github":"keita","zenn":"keita","qiita":"keita"}`
