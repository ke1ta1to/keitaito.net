...
<Image src={gameViewImage} alt="ゲーム画面" />
...
<Image src={classDiagramImage} alt="クラス図" />

Figmaを使用して、ゲームのUIデザインを行いました。

<Image src={figmaImage} alt="Figma" />
...
<Image src={websiteImage} alt="ウェブサイト" />
